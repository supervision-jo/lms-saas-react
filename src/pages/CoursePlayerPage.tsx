...
import { ChevronLeft, BookOpen, MessageSquare, Star, Send, Award, FileText, Download, Heart, ThumbsUp, Reply } from 'lucide-react';
...
const CoursePlayerPage: React.FC = () => {
  ...
  const [qaData, setQaData] = useState([
    {
      ...
      studentImage: 'https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=100',
    ...
    },
    {
      id: '2',
      student: 'Mike Chen',
      studentImage: 'https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=100',
      ...
      replies: [
        {
          ...
          authorImage: 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=100',
          isInstructor: true,
          content: 'JSX is a syntax extension for JavaScript that allows you to write HTML-like code in your JavaScript files. It gets compiled to regular JavaScript function calls. Check out the official JSX documentation at <a href="https://reactjs.org/docs/introducing-jsx.html" target="_blank" class="text-purple-600 hover:text-purple-800 underline">React JSX Guide</a> for more details.',
  ...
  const currentLesson = {
    ...
    description: 'In this lesson, we will explore what React is and why it has become one of the most popular JavaScript libraries for building user interfaces.',
    duration: '15:30',
  };
  ...
  const modules = [
    {
      ...
      lessonCount: 15,
      lessons: [
        { id: '1', title: 'What is React?', duration: '15m', type: 'video' as const, isCompleted: false, isFree: true },
        ...
        { id: '4', title: 'React Fundamentals Guide', duration: '12m', type: 'article' as const, isCompleted: false, isFree: true },
        { id: '5', title: 'Understanding JSX', duration: '18m', type: 'video' as const, isCompleted: false, isFree: false },
        { id: '6', title: 'Quick Knowledge Check', duration: '10m', type: 'quiz' as const, isCompleted: false, isFree: true },
        { id: '7', title: 'React Setup Files & Resources', duration: '5m', type: 'material' as const, isCompleted: false, isFree: false, fileUrl: '/downloads/react-setup.zip' },
        { id: '8', title: 'Module 1 Assessment', duration: '25m', type: 'exam' as const, isCompleted: false, isFree: false },
      ],
    },
    {
      id: '2',
  ...
  const handleReply = (questionId: string) => {
    if (replyText.trim()) {
      ...
      const newReply = {
        ...
        authorImage: 'https://images.pexels.com/photos/697509/pexels-photo-697509.jpeg?auto=compress&cs=tinysrgb&w=100',
        isInstructor: false,
        content: replyText,
        timestamp: 'just now',
        date: currentTime.date,
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <header className="bg-gray-800 border-b border-gray-700 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="font-semibold text-lg truncate max-w-md">{courseData.title}</h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${showNotes ? 'bg-purple-600' : 'hover:bg-gray-700'}`}
            >
              <BookOpen className="w-5 h-5" />
            </button>
            <button
              onClick={() => setShowQA(!showQA)}
              className={`p-2 rounded-lg transition-colors ${showQA ? 'bg-purple-600' : 'hover:bg-gray-700'}`}
            >
                      ...
                      <div className="max-w-4xl mx-auto">
                        <div className="flex items-center mb-6">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 mt-1">Reading time: {currentLessonData.duration}</p>
                          </div>
                        </div>
                        
                        <div className="prose prose-lg max-w-none">
                          <h2>Introduction to React Fundamentals</h2>
                          <p>React is a powerful JavaScript library for building user interfaces, particularly web applications. It was created by Facebook and has become one of the most popular tools for front-end development.</p>
                          ...
                          <ul>
                            ...
                            <li><strong>Props:</strong> Properties passed to components</li>
                            <li><strong>State:</strong> Data that changes over time in your component</li>
                          </ul>
                            ...
                            <div className="flex">
                              ...
                              <div className="ml-3">
                                <p className="text-sm text-blue-700">
                                  <strong>Pro Tip:</strong> Practice building small components as you learn. Start with simple elements like buttons and cards before moving to complex features.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <h3>Next Steps</h3>
                          <p>In the following lessons, we'll dive deeper into each of these concepts and start building real React applications. Make sure you have your development environment set up before proceeding.</p>
                        </div>
                      </div>
                    </div>
                  );
                    ...
                    <div className="bg-white rounded-lg p-8 shadow-lg">
                      <div className="max-w-4xl mx-auto">
                        <div className="flex items-center mb-6">
                          ...
                          <div>
                            <h1 className="text-3xl font-bold text-gray-900">{currentLessonData.title}</h1>
                            <p className="text-gray-600 mt-1">Quick assessment • {currentLessonData.duration}</p>
                          </div>
                        </div>
                        
                        <div className="space-y-6">
                          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                            <h3 className="text-xl font-bold text-green-800 mb-3">Question 1 of 3</h3>
                            <p className="text-lg font-medium text-gray-800 mb-6 leading-relaxed">What does JSX stand for?</p>
                            <div className="space-y-2">
                              <label className="flex items-center cursor-pointer">
                                <input type="radio" name="q1" className="h-5 w-5 text-green-600" />
                                <span className="ml-4 text-base font-medium text-gray-700">JavaScript XML</span>
                              </label>
                              <label className="flex items-center cursor-pointer">
                                <input type="radio" name="q1" className="h-5 w-5 text-green-600" />
                                <span className="ml-4 text-base font-medium text-gray-700">JavaScript Extension</span>
                              </label>
                              <label className="flex items-center cursor-pointer">
                                <input type="radio" name="q1" className="h-5 w-5 text-green-600" />
                                <span className="ml-4 text-base font-medium text-gray-700">Java Syntax Extension</span>
                              </label>
                            </div>
                          </div>
                          
                          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                            <h3 className="text-xl font-bold text-gray-800 mb-3">Question 2 of 3</h3>
                            <p className="text-lg font-medium text-gray-800 mb-6 leading-relaxed">React components must return a single parent element.</p>
                            <div className="space-y-2">
                              <label className="flex items-center cursor-pointer">
                                <input type="radio" name="q2" className="h-5 w-5 text-green-600" />
                                <span className="ml-4 text-base font-medium text-gray-700">True</span>
                              </label>
                              <label className="flex items-center cursor-pointer">
                                <input type="radio" name="q2" className="h-5 w-5 text-green-600" />
                                <span className="ml-4 text-base font-medium text-gray-700">False</span>
                              </label>
                            </div>
                          </div>
                          
                          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                            <h3 className="text-xl font-bold text-gray-800 mb-3">Question 3 of 3</h3>
                            <p className="text-lg font-medium text-gray-800 mb-6 leading-relaxed">Which company created React?</p>
                            <div className="space-y-2">
                              <label className="flex items-center cursor-pointer">
                                <input type="radio" name="q3" className="h-5 w-5 text-green-600" />
                                <span className="ml-4 text-base font-medium text-gray-700">Google</span>
                              </label>
                              <label className="flex items-center cursor-pointer">
                                <input type="radio" name="q3" className="h-5 w-5 text-green-600" />
                                <span className="ml-4 text-base font-medium text-gray-700">Facebook (Meta)</span>
                              </label>
                              <label className="flex items-center cursor-pointer">
                                <input type="radio" name="q3" className="h-5 w-5 text-green-600" />
                                <span className="ml-4 text-base font-medium text-gray-700">Microsoft</span>
                              </label>
                            </div>
                          </div>
                  ...
                  return (
                    <div className="bg-white rounded-lg p-8 shadow-lg">
                      <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 mb-4">{currentLessonData.title}</h1>
                        <p className="text-gray-600 mb-8">Download essential files and resources for this course</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                          <div className="bg-gray-50 rounded-lg p-6 border-2 border-dashed border-gray-300">
                            ...
                            <p className="text-sm text-gray-600 mb-4">Complete React project setup with all dependencies</p>
                          ...
                          <div className="bg-gray-50 rounded-lg p-6 border-2 border-dashed border-gray-300">
                            ...
                            <h3 className="font-semibold text-gray-900 mb-2">Cheat Sheet</h3>
                            <p className="text-sm text-gray-600 mb-4">Quick reference guide for React concepts</p>
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                          <div className="flex items-center">
                            ...
                            <p className="text-sm text-yellow-700">
                              <strong>Note:</strong> Make sure to extract the files to your preferred development folder before starting the exercises.
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                {!examSubmitted ? (
                  <div className="bg-gray-900 rounded-lg p-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <h3 className="text-2xl font-bold text-white mb-2">{examData.title}</h3>
                        <p className="text-gray-300">{examData.description}</p>
                      </div>
                      <div className="text-right">
                        <div className="text-white font-semibold">Time Limit: {examData.timeLimit} minutes</div>
                        <div className="text-gray-400 text-sm">Passing Score: {examData.passingScore}%</div>
                      </div>
                    </div>
                              ...
                              {question.options?.map((option, optionIndex) => (
                                <label key={optionIndex} className="flex items-center cursor-pointer">
                                  <input
                                    ...
                                    onChange={(e) => handleExamAnswer(question.id, e.target.value)}
                    ...
                    <div className="mt-8 flex items-center justify-between">
                      <div className="text-gray-400">
                        Questions answered: {Object.keys(examAnswers).length} / {examData.questions.length}
                      </div>
                      <button
                  ...
                  <div className="bg-gray-900 rounded-lg p-8 text-center">
                    <div className={`text-6xl mb-4 ${examScore! >= examData.passingScore ? 'text-green-500' : 'text-red-500'}`}>
                      {examScore! >= examData.passingScore ? '🎉' : '😞'}
                    </div>
                    <h3 className="text-3xl font-bold text-white mb-2">
                      {examScore! >= examData.passingScore ? 'Congratulations!' : 'Try Again'}
                    </h3>
                    <p className="text-xl text-gray-300 mb-6">
                      Your Score: <span className={`font-bold ${examScore! >= examData.passingScore ? 'text-green-400' : 'text-red-400'}`}>
                        {examScore}%
                      </span>
                    </p>
                    ...
                    <div className="space-y-4">
                      <div className="bg-gray-800 rounded-lg p-4">
                        <h4 className="text-white font-semibold mb-3">Results Breakdown:</h4>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div className="text-center">
                            <div className="text-green-400 font-bold text-lg">
                              {examData.questions.filter(q => examAnswers[q.id] === q.correctAnswer).length}
                            </div>
              ...
              <div className="max-w-5xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2">
                    ...
                    <div className="space-y-4">
                      {qaData.map((qa) => (
                        <div key={qa.id} className="bg-gray-900 rounded-lg p-5 border border-gray-700">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center space-x-3">
                              ...
                              />
                              <div>
                                <h4 className="font-medium text-white hover:text-purple-300 cursor-pointer transition-colors">{qa.student}</h4>
                                <p className="text-sm text-gray-400">{qa.fullTimestamp || `${qa.date} at ${qa.timestamp}`}</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="ml-11 mb-4 flex items-center space-x-4">
                            ...
                            >
                              <Heart className={`w-4 h-4 ${qa.isLiked ? 'fill-current' : ''}`} />
                              <span>{qa.likes}</span>
                            </button>
                            <button
                          ...
                          <div className="ml-11 space-y-3">
                            {qa.replies.map((reply) => (
                              <div key={reply.id} className="bg-gray-800 rounded-lg p-4 border-l-4 border-purple-500">
                                <div className="flex items-center justify-between mb-2">
                                  <div className="flex items-center space-x-2">
                                    ...
                                    />
                                    <span className="font-medium text-white hover:text-purple-300 cursor-pointer transition-colors">{reply.author}</span>
                                    {reply.isInstructor && (
                            ...
                            {replyingTo === qa.id && (
                              <div className="bg-gray-800 rounded-lg p-4 border border-gray-600">
                                <div className="flex items-center mb-3">
                                  ...
                                  />
                                  <span className="text-sm text-gray-300">Replying to {qa.student}</span>
                                </div>
                                <textarea
      ...
      {/* Rating Modal - Show after lesson completion */}
      {showRatingModal && (
        <CourseRating
          courseId="1"
        ...
        <div className="fixed bottom-4 right-4 bg-green-600 text-white p-4 rounded-lg shadow-lg z-50">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-100">Great job! Ready for the next lesson?</p>
            </div>
            <button
