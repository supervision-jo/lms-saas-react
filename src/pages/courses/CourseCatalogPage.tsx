  ...
  const courses = [
    {
      ...
      isBestseller: true,
      description:
        "Master React development with hands-on projects and real-world applications. Learn Redux, Hooks, Context API, and GraphQL.",
      lastUpdated: "2/2024",
      language: "English",
      whatYouLearn: [
    ...
    },
    {
      ...
      isBestseller: true,
      description:
        "Learn Python programming and dive into data science and machine learning with hands-on projects.",
      lastUpdated: "1/2024",
      language: "English",
      whatYouLearn: [
    ...
    },
    {
      ...
      category: "development",
      description:
        "Become a full-stack web developer with HTML, CSS, JavaScript, Node.js, React, and MongoDB.",
      lastUpdated: "3/2024",
      language: "English",
      whatYouLearn: [
    ...
    },
    {
      ...
      category: "marketing",
      description:
        "Master digital marketing with SEO, social media, Google Ads, and analytics.",
      lastUpdated: "2/2024",
      language: "English",
      whatYouLearn: [
        "SEO optimization",
    ...
    },
    {
      ...
      category: "design",
      description:
        "Learn UI/UX design principles, Figma, user research, and create stunning interfaces.",
      lastUpdated: "1/2024",
      language: "English",
      whatYouLearn: [
