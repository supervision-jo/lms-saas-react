...
const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  ...
  const categories = [
    { name: 'Web Development', icon: '💻', courses: 2847, color: 'bg-blue-500' },
    { name: 'Data Science', icon: '📊', courses: 1923, color: 'bg-green-500' },
    { name: 'Mobile Development', icon: '📱', courses: 1456, color: 'bg-purple-500' },
  ...
  const testimonials = [
    {
      ...
      quote: 'The courses here transformed my career. The quality of instruction is exceptional.',
    },
    {
      name: 'Michael Chen',
      role: 'Data Scientist at Microsoft',
      image: 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=100',
      quote: 'I went from beginner to landing my dream job in just 6 months of learning.',
    },
    {
      name: 'Emily Rodriguez',
      role: 'UX Designer at Apple',
      image: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=100',
      quote: 'The practical projects and real-world applications made all the difference.',
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl lg:text-2xl text-gray-200 max-w-lg">
                  Master new skills with expert-led courses. Join millions of learners worldwide.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">Complete React Developer Course</p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover courses in the most in-demand skills and advance your career
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((category, index) => (
              ...
              >
                <div className={`absolute top-0 right-0 w-24 h-24 ${category.color} rounded-full opacity-10 transform translate-x-8 -translate-y-8 group-hover:scale-150 transition-transform duration-500`}></div>
                
                <div className="relative z-10">
                  <div className="text-4xl mb-4">{category.icon}</div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">{category.name}</h3>
                  <p className="text-gray-600 mb-4">{category.courses.toLocaleString()} courses</p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Hand-picked courses by our experts to help you learn the most in-demand skills
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredCourses.map((course) => (
              <div key={course.id} className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer" onClick={() => onNavigate('course')}>
                <div className="relative">
                  <img
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-600 bg-gray-100 px-2 py-1 rounded">{course.level}</span>
                  </div>
                </div>
              </div>
            ))}
