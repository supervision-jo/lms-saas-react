            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="p-3 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-blue-700">Respond to questions and reviews promptly</p>
                </div>
                <div className="p-3 bg-green-50 rounded-lg">
                  <p className="font-medium text-green-900">Update Content</p>
                  <p className="text-green-700">Keep your courses current and relevant</p>
                </div>
                <div className="p-3 bg-purple-50 rounded-lg">
                  <p className="font-medium text-purple-900">Promote Courses</p>
                  <p className="text-purple-700">Share on social media and networks</p>
                </div>
              </div>
            </div>
          </div>
