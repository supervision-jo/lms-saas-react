...
import { Plus, Users, DollarSign, Star, TrendingUp, BookOpen, Play, Edit, Trash2, Eye, BarChart3, Calendar, Target, Award, MoreVertical, Archive, ArchiveRestore as Restore } from 'lucide-react';
...
const InstructorPage: React.FC<InstructorPageProps> = ({ onNavigate }) => {
  ...
  const instructorStats = [
    { label: 'Total Students', value: '12,450', icon: Users, color: 'text-blue-600', bg: 'bg-blue-100', change: '+12%' },
    { label: 'Total Revenue', value: '$45,230', icon: DollarSign, color: 'text-green-600', bg: 'bg-green-100', change: '+8%' },
    { label: 'Average Rating', value: '4.8', icon: Star, color: 'text-yellow-600', bg: 'bg-yellow-100', change: '+0.2' },
    { label: 'Course Views', value: '89,234', icon: Eye, color: 'text-purple-600', bg: 'bg-purple-100', change: '+15%' },
  ];
  ...
  const myCourses = [
    {
      ...
      thumbnail: 'https://images.pexels.com/photos/3184416/pexels-photo-3184416.jpeg?auto=compress&cs=tinysrgb&w=400',
      students: 5420,
      rating: 4.7,
      reviews: 1250,
      revenue: '$18,450',
  ...
  const analyticsData = {
    ...
    coursePerformance: [
      ...
      { name: 'JavaScript Course', students: 3200, revenue: 12800, rating: 4.6 },
          ...
          <div className="lg:col-span-2">
                          ...
                          <div className="flex items-start justify-between">
                            <div>
                              ...
                              <div className="flex items-center text-sm text-gray-600 mb-2">
                                ...
                                <span className="mr-4">Completion: {course.completion}%</span>
            ...
            {activeTab === 'analytics' && (
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {analyticsData.coursePerformance.map((course, index) => (
                      <div key={index} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        ...
                        <div className="text-right">
                          <p className="text-lg font-bold text-gray-900">${course.revenue.toLocaleString()}</p>
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-6">Student Growth</h3>
                      ...
                      {analyticsData.studentGrowth.map((value, index) => (
                        <div key={index} className="flex flex-col items-center">
                          <div 
                            ...
                            style={{ height: `${(value / Math.max(...analyticsData.studentGrowth)) * 100}%` }}
                          />
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="mt-8 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button className="px-3 py-2 text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg">2</button>
                    <button className="px-3 py-2 text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg">3</button>
                    <span className="px-3 py-2 text-sm text-gray-500">...</span>
                    <button className="px-3 py-2 text-sm text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg">15</button>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-700">Frontend Developers</span>
                      </div>
                  ...
                  <button className="w-full mt-3 text-sm text-purple-600 hover:text-purple-700 font-medium">
                    <span onClick={() => onNavigate && onNavigate('course-builder')}>Manage Groups</span>
                  </button>
                </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <button className="w-full mt-3 text-sm text-purple-600 hover:text-purple-700 font-medium">
                    <span onClick={() => onNavigate && onNavigate('course-builder')}>Edit Curriculum</span>
                  </button>
                </div>
              </div>
            </div>
