...
import { BookOpen, Clock, Award, TrendingUp, Play, CheckCircle, Star, Calendar, Users, BarChart3, Target, Trophy, ArrowRight } from 'lucide-react';
...
const DashboardPage: React.FC<DashboardPageProps> = ({ onNavigate }) => {
  ...
  const stats = [
    { label: 'Courses Enrolled', value: '12', icon: BookOpen, color: 'text-blue-600', bg: 'bg-blue-50', border: 'border-blue-200' },
    { label: 'Hours Learned', value: '156', icon: Clock, color: 'text-green-600', bg: 'bg-green-50', border: 'border-green-200' },
    { label: 'Certificates', value: '8', icon: Award, color: 'text-purple-600', bg: 'bg-purple-50', border: 'border-purple-200' },
    { label: 'Streak Days', value: '23', icon: TrendingUp, color: 'text-orange-600', bg: 'bg-orange-50', border: 'border-orange-200' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-8 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-purple-100 text-lg">Continue your learning journey and achieve your goals.</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div key={index} className={`bg-white rounded-2xl shadow-sm p-6 border-2 ${stat.border} hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1`}>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-8">
                ...
                <div className="grid grid-cols-1 gap-6">
                  {enrolledCourses.map((course) => (
                    <div key={course.id} className="group bg-gradient-to-r from-gray-50 to-white rounded-xl p-6 border border-gray-200 hover:border-purple-300 transition-all duration-300 hover:shadow-lg">
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <div className="flex items-center text-sm text-gray-500 mb-4">
                                ...
                                <span className="text-gray-400">Last accessed {course.lastAccessed}</span>
                              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {achievements.map((achievement) => (
                    <div key={achievement.id} className="bg-gradient-to-br from-purple-50 to-indigo-50 border-2 border-purple-200 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
