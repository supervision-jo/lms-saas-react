              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    <h4 className="font-semibold text-gray-900 text-base">{module.title}</h4>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <span className={`ml-3 text-sm text-left font-medium ${
                        ...
                        <div className={`flex items-center text-xs ${
                          isCurrentLesson ? 'text-purple-200' : 'text-gray-600'
                        }`}>
