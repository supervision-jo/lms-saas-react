...
const CourseRating: React.FC<CourseRatingProps> = ({
  ...
  const [selectedReasons, setSelectedReasons] = useState<string[]>(existingRating?.reasons || []);
  const [wouldRecommend, setWouldRecommend] = useState(existingRating?.wouldRecommend ?? true);
  const [anonymous, setAnonymous] = useState(existingRating?.anonymous ?? false);
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">How would you rate this course?</h3>
          ...
          {rating > 0 && (
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-4">
                What did you {rating >= 4 ? 'like' : 'dislike'} about this course?
              </h4>
          ...
          {rating > 0 && (
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Your review will be public, but your name won't be shown if you choose anonymous.
              </p>
            </div>
          )}
        </div>
